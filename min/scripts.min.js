...
*/
(()=>{let e=null,t=window.innerWidth;window.addEventListener("resize",()=>{window.requestAnimationFrame(()=>{e||(e=setTimeout(()=>{e=null,t!==window.innerWidth&&(t=window.innerWidth,PubSub.publish("windowWidthResize"))},100))})}),window.addEventListener("load",()=>{PubSub.publish("pageLoad"),Cookies.set("fastLoadScript",!0),document.documentElement.style.setProperty("--transitionDefault",".3s")}),window.cssAnimation=(e=>{let t,n,r=document.createElement("cssanimation");switch(e){case"animation":t={animation:"animationend",OAnimation:"oAnimationEnd",MozAnimation:"animationend",WebkitAnimation:"webkitAnimationEnd"};break;case"transition":t={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"}}for(n in t)if(void 0!==r.style[n])return t[n]}),window.isInViewport=(e=>{const t=e.getBoundingClientRect();return t.top>=0&&t.bottom<=window.innerHeight}),window.sepNumber=(e=>(e=(e=e.toString()).replace(/\s+/g,"")).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g,"$1 ")),window.strToNumber=(e=>parseInt(e.replace(/\s+/g,""),10)),window.declension=((e,t)=>{let n,r=e%100;return n=r>4&&r<21?t[2]:1==(r%=10)?t[0]:r>1&&r<5?t[1]:t[2]})})(),(e=>{e.length&&Array.from(e,e=>{e.addEventListener("click",t=>{t.target.closest(".visible-toggle-password__btn")&&(Array.from(e.querySelectorAll(".visible-toggle-password__input"),e=>e.type="password"===e.type?"text":"password"),Array.from(e.querySelectorAll(".visible-toggle-password__btn svg"),e=>e.classList.toggle("hide")))})})})(document.querySelectorAll(".visible-toggle-password")),(e=>{const t=document.querySelector(".cart__list");e.length&&Array.from(e,e=>{const n=e.closest(".cart__item");e.querySelector(".btn").addEventListener("click",()=>{n.style.height=n.clientHeight+"px",n.addEventListener(window.cssAnimation("transition"),()=>{0===n.clientHeight&&(n.remove(),setTimeout(()=>t.dispatchEvent(new CustomEvent("submit"))))}),setTimeout(()=>n.classList.add("is-remove"))})})})(document.querySelectorAll(".cart__item-remove")),(e=>{if(!e)return;const t=e.querySelectorAll(".cart-quantity");t.length&&Array.from(t,t=>{let n=null;const r=t.querySelector(".cart-quantity__btn--up"),o=t.querySelector(".cart-quantity__btn--down"),i=t.querySelector(".cart-quantity__count");r.addEventListener("click",()=>{n=parseInt(i.value)+1,i.value=n,e.dispatchEvent(new CustomEvent("change"))}),o.addEventListener("click",()=>{(n=parseInt(i.value)-1)<1&&(n=1),i.value=n,e.dispatchEvent(new CustomEvent("change"))}),i.addEventListener("blur",()=>{e.dispatchEvent(new CustomEvent("change"))}),i.addEventListener("focus",()=>{setTimeout(()=>i.setSelectionRange(0,9),100)}),i.addEventListener("keyup",()=>{const t=this.value.replace(/[\D]/g,"");this.value=t,e.dispatchEvent(new CustomEvent("change"))})})})(document.querySelector(".cart")),(e=>{e.length&&Array.from(e,e=>{const t=e.querySelector(".menu-category__toggle"),n=e.querySelector(".menu-category__wrap"),r=e.querySelector(".menu-category__list");t&&t.addEventListener("click",()=>{n.style.height=r.clientHeight+"px",setTimeout(()=>{e.classList.toggle("is-open"),n.style.height=r.clientHeight+"px"},100)})})})(document.querySelectorAll(".menu-category__section")),(e=>{e.length&&Array.from(e,e=>{const t=e.querySelector(".category-cards__toggle");if(t){const n=t.querySelector(".btn"),r=e.querySelector(".category-cards__wrap"),o=e.querySelector(".category-cards__list");n.addEventListener("click",()=>{r.style.height=o.clientHeight+"px",setTimeout(()=>{e.classList.toggle("is-open"),r.style.height=o.clientHeight+"px"},100)})}})})(document.querySelectorAll(".category-cards")),(e=>{e.length&&Array.from(e,e=>{e.querySelector(".content-block__toggle").addEventListener("click",()=>e.classList.toggle("is-open"))})})(document.querySelectorAll(".content-block")),(e=>{if(e){const t=document.querySelector(".catalog__result"),n=(e.querySelectorAll(".filter__fieldset"),document.createElement("div"));n.className="catalog__loading hide",t.insertAdjacentElement("afterbegin",n),e.addEventListener("change",t=>{const r=t.target;if("checkbox"===r.type){const t=r.getAttribute("name"),n=e.querySelector('.filter__checkbox-all[name="'+t+'"]');if(n){const o=Array.from(e.querySelectorAll('input[name="'+t+'"]')).filter(e=>e!==n);r===n?Array.from(o,e=>e.checked=n.checked):n.checked=o.every(e=>!0===e.checked)}}console.log(e,"change");const o=new FormData(e),i=new URLSearchParams(o).toString();history.pushState(void 0,"","?"+i),n.classList.remove("hide")}),e.addEventListener("submit",t=>{t.preventDefault(),e.dispatchEvent(new CustomEvent("change"))}),e.addEventListener("default",()=>{Array.from(e.querySelectorAll(".checkbox__input:checked:not(:disabled)"),e=>e.checked=!1),Array.from(e.querySelectorAll(".nouislider"),e=>e.dispatchEvent(new CustomEvent("reset"))),e.dispatchEvent(new CustomEvent("change"))})}})(document.querySelector(".filter")),(e=>{e.length&&Array.from(e,e=>{const t=document.querySelector("#"+e.getAttribute("data-id")),n=e.querySelectorAll(".sort__item"),r=e.elements.direction;Array.from(n,o=>{o.addEventListener("click",()=>{o.classList.contains("is-active")?o.classList.contains("is-revert")?(o.classList.remove("is-revert"),t.elements.direction.value=r.value):(o.classList.add("is-revert"),t.elements.direction.value=r.getAttribute("data-alt")):(o.insertAdjacentElement("beforeend",e.querySelector(".sort__item svg")),Array.from(n,e=>{e.classList.toggle("is-active",o===e)}),t.elements.sort.value=o.getAttribute("data-value")),t.dispatchEvent(new CustomEvent("change"))})})})})(document.querySelectorAll(".filter-sort-trigger")),(e=>{e.length&&Array.from(e,e=>{const t=document.querySelector("#"+e.getAttribute("data-id")),n=e.querySelectorAll(".filter-tags-trigger__tag");Array.from(n,r=>{r.addEventListener("click",()=>{if(r.classList.contains("filter-tags-trigger__tag--reset"))e.classList.add("is-remove"),setTimeout(()=>{Array.from(n,t=>{r!==t&&(t.remove(),e.classList.add("hide"))})},500),t.dispatchEvent(new CustomEvent("default"));else{const e=r.getAttribute("data-name"),n=r.getAttribute("data-value");console.log(e,n),"nouislider"===e?t.querySelector(".nouislider--"+n).dispatchEvent(new CustomEvent("reset")):t.querySelector(`[name="${e}"][value="${n}"]`).checked=!1,r.classList.add("is-remove"),setTimeout(()=>r.remove(),500),t.dispatchEvent(new CustomEvent("change"))}})})})})(document.querySelectorAll(".filter-tags-trigger")),(e=>{if(!e)return;const t=document.querySelector("#modal-cart-template");document.addEventListener("submit",n=>{const r=n.target.closest(".form-buy");if(r){const o=r.querySelector(".form-buy__submit");o.disabled=!0,n.preventDefault(),r.classList.add("is-loading"),fetch(r.getAttribute("action"),{method:"POST",body:new FormData(r)}).then(e=>e.json()).then(n=>{console.log(n),r.classList.remove("is-loading"),o.disabled=!1,e.innerHTML=Mustache.render(t.content.cloneNode(!0),n);const i=new CustomEvent("modalShow",{detail:{selector:"cart"}});window.modal.dispatchEvent(i)})}}),e.addEventListener("change",()=>{e.classList.add("is-loading"),fetch(e.getAttribute("action"),{method:"POST",body:new FormData(e)}).then(e=>e.json()).then(t=>{console.log(t),e.classList.remove("is-loading"),t.id==e.elements.id.value?(e.querySelector(".modal-cart__count").value=t.count,e.querySelector(".modal-cart__total-text").textContent=t.totalText):(e.elements.id.value=t.id,e.querySelector(".modal-cart__img").href=t.link,e.querySelector(".modal-cart__img img").src=t.img,e.querySelector(".modal-cart__name").href=t.link,e.querySelector(".modal-cart__name").textContent=t.name,e.querySelector(".modal-cart__intro").textContent=t.description,t.priceOld&&e.querySelector(".price__old")?(e.querySelector(".price__sale").textContent=t.price,e.querySelector(".price__old").textContent=t.priceOld):e.querySelector(".price").textContent=t.price,e.querySelector(".modal-cart__count").value=t.count,e.querySelector(".modal-cart__total-text").textContent=t.totalText)})}),e.addEventListener("submit",t=>{t.preventDefault(),e.dispatchEvent(new CustomEvent("change"))}),e.addEventListener("keyup",t=>{console.log(t.key),t.target.classList.contains("quantity__input")&&(t.target.value=t.target.value.replace(/[\D]/g,""),e.dispatchEvent(new CustomEvent("change")))}),e.addEventListener("click",t=>{const n=e.querySelector(".quantity__input");t.target===n&&n.setSelectionRange(0,9),t.target.closest(".quantity__btn--up")&&(n.value=parseInt(n.value)+1,e.dispatchEvent(new CustomEvent("change"))),t.target.closest(".quantity__btn--down")&&(n.value=parseInt(n.value)<=1?1:parseInt(n.value)-1,e.dispatchEvent(new CustomEvent("change")))})})(document.querySelector(".modal-cart")),(e=>{if(!e)return;const t=e.querySelector(".form-city__list"),n=t.querySelectorAll(".form-city__btn"),r=e.querySelector(".form-city__input-filter");let o=n.length;const i=()=>{fetch(e.getAttribute("action"),{method:"POST",body:new FormData(e)}).then(e=>e.json()).then(e=>{console.log(e),e.setCity&&(Array.from(document.querySelectorAll(".js-change-city"),t=>t.textContent=e.setCity),modal.dispatchEvent(new CustomEvent("hide")))})};r.addEventListener("input",e=>{const i=r.value.toLowerCase();o=0,i.length>0?Array.from(n,e=>{const t=e.getAttribute("data-name").toLowerCase();e.classList.toggle("hide",-1===t.indexOf(i)),-1!==t.indexOf(i)&&o++}):(Array.from(n,e=>e.classList.remove("hide")),o=n.length),t.classList.toggle("is-empty",0===o)}),Array.from(n,e=>{e.querySelector(".form-city__radio").addEventListener("change",()=>i())}),e.addEventListener("submit",e=>{e.preventDefault(),1===o&&Array.from(n,e=>e.querySelector(".form-city__radio").checked=!1===e.classList.contains("hide")),r.value.length>0&&i()})})(document.querySelector(".form-city")),(e=>{e.length&&Array.from(e,e=>{const t=e.querySelector(".form__submit"),n=e.querySelector(".form__ok"),r=e.querySelector(".form__error");e.addEventListener("submit",o=>{o.preventDefault(),e.classList.add("is-loading"),t.disabled=!0,fetch(e.getAttribute("action"),{method:"POST",body:new FormData(e)}).then(e=>e.json()).then(o=>{if(console.log(o),e.classList.remove("is-loading"),t.disabled=!1,"ok"===o.type&&modal.ok(o.title,o.text),n&&("form-ok"===o.type?(n.textContent=o.text,n.classList.remove("hide"),window.isInViewport(n)||n.scrollIntoView({behavior:"smooth"})):n.classList.add("hide")),r&&("form-error"===o.type?(r.textContent=o.text,r.classList.remove("hide"),window.isInViewport(r)||r.scrollIntoView({behavior:"smooth"})):r.classList.add("hide")),o.redirect){const e=o.redirectDelay?1e3*o.redirectDelay:0;setTimeout(()=>location.assign(o.redirect),e)}o.reset&&e.reset(),o.refresh&&location.reload()})})})})(document.querySelectorAll(".form")),(e=>{if(e){const t=e.querySelectorAll(".swiper-gallery-preview__big-item");e.addEventListener("click",n=>{if(n.target.closest(".swiper-gallery-preview__link")&&(n.preventDefault(),null===n.target.closest(".swiper-container-style"))){const r=n.target.closest(".swiper-gallery-preview__item");Array.from(e.querySelectorAll(".swiper-gallery-preview__item"),(e,n)=>{e.classList.toggle("is-current",r===e),t[n].classList.toggle("hide",r!==e)})}})}})(document.querySelector(".swiper-gallery-preview")),(e=>{if(e){document.documentElement.style.setProperty("--heightHeader",e.clientHeight+"px");const t=e.querySelector(".header__bottom"),n=t.querySelector(".header__flex"),r=document.querySelector(".product-scroll"),o=document.querySelector(".product__form-buy");r&&e.insertAdjacentElement("afterend",r),window.addEventListener("scroll",()=>{window.requestAnimationFrame(()=>{const i=n.clientHeight;let a=i-window.pageYOffset,s=(i/2-window.pageYOffset)/(i/2);a<0&&(a=0),s<0?(s=0,n.classList.add("is-off")):n.classList.remove("is-off"),t.style.height=a+"px",t.style.opacity=s,document.documentElement.style.setProperty("--heightHeader",e.clientHeight+"px"),r&&r.classList.toggle("is-show",!1===window.isInViewport(o))})})}})(document.querySelector(".header")),(e=>{if(e.length){const t=document.querySelector("#modal-form-address-remove");Array.from(e,e=>{e.addEventListener("click",()=>{t.elements.id.value=e.getAttribute("data-id"),t.querySelector(".modal-login__text").textContent=e.getAttribute("data-text")})})}})(document.querySelectorAll('[data-modal="account-address-remove"]')),(e=>{if(e.length){const t=document.querySelector("#modal-form-card-remove");Array.from(e,e=>{e.addEventListener("click",()=>{t.elements.id.value=e.getAttribute("data-id"),t.querySelector(".modal-login__text").textContent=e.getAttribute("data-text")})})}})(document.querySelectorAll('[data-modal="account-card-remove"]')),(e=>{e&&e.addEventListener("change",()=>{e.dispatchEvent(new CustomEvent("submit"))})})(document.querySelector(".lk-filter")),(e=>{e.length&&Array.from(e,e=>{const t=e.querySelector(".lk-order__foot .btn");t&&t.addEventListener("click",()=>e.classList.toggle("is-short"))})})(document.querySelectorAll(".lk-order")),(e=>{if(!e.length)return;const t=document.createElement("script");t.src="/bitrix/templates/chistovgorode/js/inputmask.min.js",t.onload=(()=>{Array.from(e,e=>{let t;e.classList.contains("inputmask--phone")&&(t=new Inputmask({mask:"+7 (999) 999 99 99",showMaskOnHover:!1})),t.mask(e)})}),setTimeout(()=>document.head.appendChild(t),Cookies.get("fastLoadScript")?0:1e4)})(document.querySelectorAll(".inputmask")),(e=>{if(e){let t=window.pageYOffset;e.addEventListener("click",()=>{document.body.classList.contains("menu-catalog-show")?(document.body.classList.remove("menu-catalog-show"),window.scrollTo(0,t)):(t=window.pageYOffset,document.body.classList.add("menu-catalog-show"),window.scrollTo(0,0))})}})(document.querySelector(".btn-toggle-menu-catalog")),(e=>{if(e.length){const t=document.querySelectorAll(".menu-catalog__body");Array.from(e,n=>{n.addEventListener("click",()=>{Array.from(e,(e,r)=>{e.classList.toggle("is-current",e===n),t[r].classList.toggle("hide",e!==n)})})})}})(document.querySelectorAll(".menu-catalog__nav-btn")),(e=>{if(!e)return;const t=e.querySelectorAll(".modal__item"),n=(document.querySelectorAll("[data-modal]"),document.querySelector(".wrapper"));let r=null,o=window.pageYOffset;e.addEventListener("hide",()=>{document.body.classList.remove("modal-show"),n.style.top=0,window.scrollTo(0,o),r=!1,setTimeout(()=>document.documentElement.classList.remove("scroll-behavior-off"))}),e.addEventListener("keyup",t=>{"Escape"===t.key&&e.dispatchEvent(new CustomEvent("hide"))});const i=i=>{r||(o=window.pageYOffset),r=e.querySelector(".modal__item--"+i),Array.from(t,e=>e.classList.toggle("visuallyhidden",e!==r)),document.documentElement.classList.add("scroll-behavior-off"),setTimeout(()=>{n.style.top=-o+"px",document.body.classList.add("modal-show"),window.scrollTo(0,0),r.focus(),PubSub.publish("open-"+i)})};e.addEventListener("click",t=>{(t.target.classList.contains("modal")||t.target.closest(".modal__close"))&&e.dispatchEvent(new CustomEvent("hide"))}),document.addEventListener("click",e=>{let t=e.target;for(;t!==document;)t.hasAttribute("data-modal")&&i(t.getAttribute("data-modal")),t=t.parentNode}),e.addEventListener("modalShow",e=>i(e.detail.selector)),e.ok=((t,n)=>{e.querySelector(".modal__item--ok .modal-login__head").innerHTML=t||"",e.querySelector(".modal__item--ok .modal-login__text").innerHTML=n||"",i("ok")})})(document.querySelector(".modal")),(e=>{if(!e.length)return;const t=document.createElement("script");t.src="/bitrix/templates/chistovgorode/js/nouislider.min.js",t.onload=(()=>void Array.from(e,e=>{const t=e.querySelector(".nouislider__track"),n=e.closest("form"),r=e.querySelector(".nouislider__min"),o=e.querySelector(".nouislider__max"),i=parseInt(e.getAttribute("data-min")),a=parseInt(e.getAttribute("data-max")),s=parseInt(e.getAttribute("data-step")),l=e.getAttribute("data-suf");noUiSlider.create(t,{start:[i,a],step:s,connect:!0,range:{min:i,max:a},format:{to:e=>parseInt(e),from:e=>parseInt(e)}}),t.noUiSlider.on("slide",e=>{l?(r.value=window.sepNumber(e[0])+" "+l,o.value=window.sepNumber(e[1])+" "+l):(r.value=parseInt(e[0]),o.value=parseInt(e[1]))}),t.noUiSlider.on("end",e=>{r.classList.toggle("is-side",i===e[0]),o.classList.toggle("is-side",a===e[1]),n.dispatchEvent(new CustomEvent("change"))}),t.noUiSlider.on("update",e=>{r.classList.toggle("is-side",i===e[0]),o.classList.toggle("is-side",a===e[1])}),n.addEventListener("reset",()=>{t.noUiSlider.set([i,a])}),e.addEventListener("reset",()=>{t.noUiSlider.set([i,a])}),n.addEventListener("input",e=>{e.target!==o&&e.target!==r||t.noUiSlider.set([parseInt(window.strToNumber(r.value)),parseInt(window.strToNumber(o.value))])}),r.addEventListener("focus",()=>{r.value=t.noUiSlider.get()[0],r.setSelectionRange(0,99)}),o.addEventListener("focus",()=>{o.value=t.noUiSlider.get()[1],o.setSelectionRange(0,99)}),r.addEventListener("blur",()=>{l&&(r.value=window.sepNumber(t.noUiSlider.get()[0])+" "+l)}),o.addEventListener("blur",()=>{l&&(o.value=window.sepNumber(t.noUiSlider.get()[1])+" "+l)}),r.addEventListener("keyup",e=>{"Enter"===e.key&&r.blur()}),o.addEventListener("keyup",e=>{"Enter"===e.key&&o.blur()}),i===parseInt(window.strToNumber(r.value))&&a===parseInt(window.strToNumber(o.value))||t.noUiSlider.set([parseInt(window.strToNumber(r.value)),parseInt(window.strToNumber(o.value))])})),setTimeout(()=>document.head.appendChild(t),Cookies.get("fastLoadScript")?0:1e4)})(document.querySelectorAll(".nouislider")),window.selects=(e=>{if(e.querySelector(".select__list"))return;const t=document.createElement("div");t.className="select__value",t.innerHTML='<span class="select__value-inner"></span>',t.insertAdjacentHTML("beforeend",'<svg width="24" height="24" viewBox="0 0 24 24"><path d="M7.2 9.2a.65.65 0 0 1 .91 0L12 13.12l3.89-3.94a.65.65 0 0 1 .92 0c.25.26.25.68 0 .94L12 15l-4.8-4.87a.67.67 0 0 1 0-.94Z"/></svg>'),e.appendChild(t);const n=e.closest("form"),r=e.querySelector("select"),o=e.querySelectorAll("option"),i=e.querySelector(".select__value-inner"),a=(e.classList.contains("select--filter"),document.createElement("div"));a.className="select__list";const s=r.querySelector('[value="'+r.value+'"]').textContent;(r.disabled||"none"===r.value||""===r.value)&&e.classList.add("select--default"),""!==r.value&&(i.textContent=e.querySelector('option[value="'+r.value+'"]').textContent),Array.from(o,t=>{const n=document.createElement("label"),o=document.createElement("span"),s=document.createElement("input");n.className="select__list-item",s.type="radio",s.name=r.name,s.value=t.value,o.textContent=t.textContent,r.value===t.value&&(s.checked=!0),s.addEventListener("change",()=>{i.textContent=t.textContent,e.classList.remove("select--open")}),n.appendChild(s),n.appendChild(o),a.appendChild(n)}),e.appendChild(a),n&&n.addEventListener("reset",()=>{e.classList.add("select--default"),i.textContent=s}),r.remove()}),window.selectsCollection=document.querySelectorAll(".select"),window.selectsCollection.length&&Array.from(window.selectsCollection,e=>window.selects(e)),window.addEventListener("click",e=>{const t=e.target.closest(".select");Array.from(window.selectsCollection,e=>{e.classList.toggle("select--open",e===t&&!1===t.classList.contains("select--open"))})}),(e=>{if(!e.length)return;Array.from(e,e=>{let t=null,n=null,r=null;const o=document.createElement("div"),i=document.createElement("div"),a=document.createElement("div"),s=document.createElement("button"),l=document.createElement("button"),c=(e.parentNode.querySelector(".swiper-scrollbar"),e.querySelectorAll(".swiper-slide")),d=(c.length,e.classList.contains("swiper-container--card-auto")),u=e.classList.contains("swiper-container--billboard"),m=e.classList.contains("swiper-container--gallery-preview");i.className="swiper-pagination",o.className="swiper-controls",a.className="swiper-navigation",l.className="swiper-button-prev button",s.className="swiper-button-next button",l.setAttribute("aria-label","Previous slide"),s.setAttribute("aria-label","Next slide"),m?(l.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24"><path d="m13 9 4.6 4.6a1 1 0 1 1-1.4 1.4l-3.9-3.9L8.4 15A.99.99 0 0 1 7 13.6L11.59 9A1 1 0 0 1 13 9Z"/></svg>',s.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24"><path d="M13 15a1 1 0 0 1-1.4 0L7 10.4A.99.99 0 0 1 8.4 9l3.9 3.9L16.2 9a.99.99 0 0 1 1.4 1.4L13 15Z"/></svg>'):(l.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24"><path d="M8.41 11.5H18a1 1 0 0 1 0 2H8.41l3.8 3.8a1 1 0 0 1-1.42 1.4l-5.5-5.5a1 1 0 0 1 0-1.4l5.5-5.5a1 1 0 0 1 1.42 1.4l-3.8 3.8Z"/></svg>',s.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24"><path d="M11.8 5.8a1 1 0 0 0 0 1.4l3.79 3.8H6a1 1 0 0 0 0 2h9.59l-3.8 3.8a1 1 0 1 0 1.42 1.4l5.5-5.5a1 1 0 0 0 .29-.67v-.06a1 1 0 0 0-.3-.68l-5.5-5.5a1 1 0 0 0-1.4 0Z"/></svg>'),a.appendChild(l),a.appendChild(s),o.appendChild(a),o.appendChild(i),u&&((r=(()=>{t&&(t.destroy(!1,!0),t=void 0),i.classList.add("hide"),a.classList.add("hide"),o.classList.add("hide"),e.parentNode.classList.remove("swiper-container-style")}))(),o.classList.add("center"),i.classList.remove("hide"),o.classList.remove("hide"),n=(()=>{n=!1,e.parentNode.classList.add("swiper-container-style"),new Swiper(e,{loop:!0,autoplay:{delay:5e3},pagination:{el:i,clickable:!0,bulletClass:"button",bulletActiveClass:"is-active"}})})),d&&(i.classList.add("hide"),n=(()=>{n=!1,e.parentNode.parentNode.appendChild(o),l.classList.add("swiper-button-disabled"),new Swiper(e,{slidesPerView:"auto",navigation:{nextEl:s,prevEl:l}})})),m&&(n=(()=>{let t=0;e.parentNode.appendChild(o),Array.from(c,(e,n)=>{e.classList.contains("is-current")&&(t=n)}),n=!1,e.parentNode.classList.add("swiper-container-style");const r=e.closest(".swiper-gallery-preview").querySelectorAll(".swiper-gallery-preview__big-item");new Swiper(e,{loop:!0,slideActiveClass:"is-current",direction:"vertical",slidesPerView:5,spaceBetween:15,slideToClickedSlide:!0,initialSlide:t,navigation:{nextEl:s,prevEl:l},on:{slideChange:()=>{Array.from(r,(t,n)=>{t.classList.toggle("hide",e.swiper.realIndex!==n),t.querySelector("video")&&t.querySelector("video").pause()})}},breakpoints:{320:{slidesPerView:3,spaceBetween:8},768:{slidesPerView:5,spaceBetween:15}}})})),PubSub.subscribe("windowWidthResize",()=>{window.Swiper&&n&&n()}),PubSub.subscribe("swiperJsLoad",()=>{e.appendChild(o),Array.from(e.querySelectorAll('[loading="lazy"]'),e=>e.setAttribute("loading","eager")),Array.from(c,e=>e.classList.remove("hide")),n()})});const t=document.createElement("script");t.src="/bitrix/templates/chistovgorode/js/swiper.min.js",t.onload=(()=>PubSub.publish("swiperJsLoad")),setTimeout(()=>document.head.appendChild(t),Cookies.get("fastLoadScript")?0:1e4)})(document.querySelectorAll(".swiper-container"));